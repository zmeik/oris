...
(function (global) {
  ...
  const I18N = {
    ru: {
      ...
      // ─── Root / PAI / Furcation hints inside the picker ───
      pickerHintCanal:      'Клик на канал = цикл заполнения',
      pickerHintApex:       'Клик на апекс = периапикальная находка (PAI, Ørstavik 1986)',
      pickerHintFurc:       'Клик на бифуркацию = Glickman I-IV · Клик на бок корня = лат. дефект',
      pickerCycleNext:      'Клик = следующее состояние',

      // PAI states (cyclable label after the apex hint)
      paiState_norm:        '● Норма',
      paiState_pdl:         '● Расш. периодонт. щель',
      paiState_lt5mm:       '● PA <5мм',
      paiState_ge5mm:       '● PA ≥5мм',
      paiState_gt10mm:      '● PA >10мм',

      pickerPaiHelpSummary: '📖 Справка PAI + литература',
      pickerPai1:           '<b>PAI 1</b> — Норма: интактная lamina dura',
      pickerPai2:           '<b>PAI 2</b> — Расш. периодонт. щель: ранний признак воспаления',
      pickerPai3:           '<b>PAI 3</b> — Периапик. поражение <5мм: очаг разрежения',
      pickerPai4:           '<b>PAI 4</b> — Периапик. поражение ≥5мм: выраженный очаг',
      pickerPai5:           '<b>PAI 5</b> — Обширное поражение >10мм: показана КЛКТ',
      pickerPaiHistDisclaimer: '<i>На рентгенограмме невозможно отличить гранулёму от кисты — дифференциация только гистологически.</i>',

      pickerFurcHelpSummary: '📖 Справка: фуркация + пародонт',
      pickerFurcGlickmanTitle: '<b>Фуркация (Glickman 1955)</b>',
      pickerFurcGlickman1:  'I — начальная (на OPG не видна)',
      pickerFurcGlickman2:  'II — неполная потеря кости между корнями',
      pickerFurcGlickman3:  'III — сквозной дефект (видно разрежение)',
      pickerFurcGlickman4:  'IV — обнажённая фуркация',
      pickerLatDefectsTitle:'<b>Латеральные дефекты</b>',
      pickerLatDefectsLine: 'V↓ — вертикальный (angular) · H— — горизонтальный · U — кратер',
      pickerEndoPerioTitle: '<b>Эндо-перио</b>',
      pickerEndoPerioLine:  'J — J-образное (от апекса к краю) · ◯ — Halo · ⊕ — комбинированное',
      // legend chips (1 char each — kept identical RU/EN)
      pickerFurcChipF1:     '◼ Ф1',
      pickerFurcChipF2:     '◼ Ф2',
      pickerFurcChipF34:    '◼ Ф3-4',
      pickerLatChipV:       '│V↓',
      pickerLatChipH:       '│H—',
      pickerLatChipU:       '│U',

      // ─── WEAR (TWI) ───
      pickerWearTitle:      'СТИРАЕМОСТЬ / WEAR',
      pickerTWINone:        'TWI0: Нет потери',
      pickerTWITitle:       'Клик = следующий TWI',

      // ─── FRACTURES section ───
      pickerFracTitle:      '⚡ ПЕРЕЛОМЫ / FRACTURES',
      pickerFracRootDesc:   'Корень — выберите тип перелома (AAE + Andreasen):',
      pickerFracCrownDesc:  'Коронка — раскол или трещина (если видно на OPG):',
      // root fracture state names
      fracRoot_none:        'Нет перелома',
      fracRoot_vrf:         'VRF (вертикальный)',
      fracRoot_hrz_cervical:'H⅓↑ (шеечная)',
      fracRoot_hrz_middle:  'H⅓M (средняя)',
      fracRoot_hrz_apical:  'H⅓A (апикальная)',
      // crown fracture state names
      fracCrown_none:       'Нет',
      fracCrown_split:      'Раскол (split tooth)',
      fracCrown_cracked:    'Трещина (подозрение)',
      fracCrown_noneDesc:   'Нет перелома коронки',
      fracCrown_splitDesc:  'Раскол зуба — полное разделение на два фрагмента через пульповую камеру. На OPG видна щель.',
      fracCrown_crackedDesc:'Подозрение на трещину — на OPG косвенные признаки: расш. PDL, нарушение lamina dura с одной стороны.',

      // section headers for the FDI tooltip / context menu
      tdSecCanals:          'КАНАЛЫ',
      tdSecPeriapical:      'ПЕРИАПИКАЛЬНО',
      tdSecPerio:           'ПАРОДОНТ',
      tdSecWear:            'СТИРАЕМОСТЬ',
      tdSecFractures:       'ПЕРЕЛОМЫ',
      pickerAddLayer:       '＋слой',
      pickerAddLayerTitle:  'Добавить слой (Э+Ш+К)',
    ...
    en: {
      ...
      pickerAddLayerTitle:  'Add a layer (E+P+C)',

      pickerHintCanal:      'Click canal = cycle fill state',
      pickerHintApex:       'Click apex = periapical finding (PAI, Ørstavik 1986)',
      pickerHintFurc:       'Click furcation = Glickman I-IV · Click root side = lateral defect',
      pickerCycleNext:      'Click = next state',

      paiState_norm:        '● Normal',
      paiState_pdl:         '● Widened PDL',
      paiState_lt5mm:       '● PA <5mm',
      paiState_ge5mm:       '● PA ≥5mm',
      paiState_gt10mm:      '● PA >10mm',

      pickerPaiHelpSummary: '📖 PAI reference + literature',
      pickerPai1:           '<b>PAI 1</b> — Normal: intact lamina dura',
      pickerPai2:           '<b>PAI 2</b> — Widened PDL: early sign of inflammation',
      pickerPai3:           '<b>PAI 3</b> — Periapical lesion <5mm: rarefying focus',
      pickerPai4:           '<b>PAI 4</b> — Periapical lesion ≥5mm: pronounced lesion',
      pickerPai5:           '<b>PAI 5</b> — Extensive lesion >10mm: CBCT indicated',
      pickerPaiHistDisclaimer: '<i>Radiograph cannot distinguish granuloma from cyst — differentiation by histology only.</i>',

      pickerFurcHelpSummary: '📖 Reference: furcation + periodontal',
      pickerFurcGlickmanTitle: '<b>Furcation (Glickman 1955)</b>',
      pickerFurcGlickman1:  'I — incipient (not visible on OPG)',
      pickerFurcGlickman2:  'II — partial bone loss between roots',
      pickerFurcGlickman3:  'III — through-and-through defect (lucency visible)',
      pickerFurcGlickman4:  'IV — exposed furcation',
      pickerLatDefectsTitle:'<b>Lateral defects</b>',
      pickerLatDefectsLine: 'V↓ — vertical (angular) · H— — horizontal · U — crater',
      pickerEndoPerioTitle: '<b>Endo-perio</b>',
      pickerEndoPerioLine:  'J — J-shaped (apex to margin) · ◯ — Halo · ⊕ — combined',
      pickerFurcChipF1:     '◼ F1',
      pickerFurcChipF2:     '◼ F2',
      pickerFurcChipF34:    '◼ F3-4',
      pickerLatChipV:       '│V↓',
      pickerLatChipH:       '│H—',
      pickerLatChipU:       '│U',

      pickerWearTitle:      'WEAR (TWI)',
      pickerTWINone:        'TWI0: No loss',
      pickerTWITitle:       'Click = next TWI',

      pickerFracTitle:      '⚡ FRACTURES',
      pickerFracRootDesc:   'Root — pick fracture type (AAE + Andreasen):',
      pickerFracCrownDesc:  'Crown — split or crack (if visible on OPG):',
      fracRoot_none:        'No fracture',
      fracRoot_vrf:         'VRF (vertical)',
      fracRoot_hrz_cervical:'H⅓↑ (cervical)',
      fracRoot_hrz_middle:  'H⅓M (middle)',
      fracRoot_hrz_apical:  'H⅓A (apical)',
      fracCrown_none:       'None',
      fracCrown_split:      'Split (split tooth)',
      fracCrown_cracked:    'Crack (suspected)',
      fracCrown_noneDesc:   'No crown fracture',
      fracCrown_splitDesc:  'Split tooth — complete separation into two fragments through the pulp chamber. Visible as a gap on OPG.',
      fracCrown_crackedDesc:'Suspected crack — on OPG indirect signs: widened PDL, lamina-dura disruption on one side.',

      tdSecCanals:          'CANALS',
      tdSecPeriapical:      'PERIAPICAL',
      tdSecPerio:           'PERIODONTAL',
      tdSecWear:            'WEAR',
      tdSecFractures:       'FRACTURES',
      pickerAddLayer:       '+ layer',
